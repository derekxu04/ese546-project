"""Impl-local helpers for downloading and loading Sudoku datasets.

This mirrors the project-level ``data_sudoku.py`` so training scripts under
``impl/`` can import without needing sys.path tweaks.
"""
